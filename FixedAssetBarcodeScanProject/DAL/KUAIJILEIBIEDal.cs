...
{
    /// <summary>
    /// 数据访问类:KUAIJILEIBIEDal
    /// </summary>
    public partial class KUAIJILEIBIEDal
    {
        public KUAIJILEIBIEDal()
        { }
        #region  Method
        ...
        public bool Exists(string LEIBIEBIANMA)
        {
            ...
            strSql.Append("select count(1) from KUAIJILEIBIE");
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(CCT.Model.KUAIJILEIBIEModel model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(CCT.Model.KUAIJILEIBIEModel model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update KUAIJILEIBIE set ");
        ...
        public bool Delete(string LEIBIEBIANMA)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from KUAIJILEIBIE ");
            strSql.Append(" where LEIBIEBIANMA=@LEIBIEBIANMA ");
            SqlParameter[] parameters = {
					new SqlParameter("@LEIBIEBIANMA", SqlDbType.NVarChar,50)};
            parameters[0].Value = LEIBIEBIANMA;
        ...
        /// 得到一个对象实体
        /// </summary>
        public CCT.Model.KUAIJILEIBIEModel GetModel(string LEIBIEBIANMA)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 LEIBIEBIANMA,LEIBIEMINGCHENG from KUAIJILEIBIE ");
            strSql.Append(" where LEIBIEBIANMA=@LEIBIEBIANMA ");
            SqlParameter[] parameters = {
					new SqlParameter("@LEIBIEBIANMA", SqlDbType.NVarChar,50)};
            parameters[0].Value = LEIBIEBIANMA;

            CCT.Model.KUAIJILEIBIEModel model = new CCT.Model.KUAIJILEIBIEModel();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM KUAIJILEIBIE");
            if (strWhere.Trim() != "")
            {
        ...
        public Hashtable GetHashtable(string strWhere)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                ht.Add(dr["LEIBIEBIANMA"].ToString().Trim(), dr["LEIBIEMINGCHENG"].ToString().Trim());
            }
            return ht;
        }
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "KUAIJILEIBIE";
