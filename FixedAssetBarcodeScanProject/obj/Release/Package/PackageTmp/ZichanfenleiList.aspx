<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZichanfenleiList.aspx.cs" Inherits="FixedAssetBarcodeScanProject.ZichanfenleiList" %>
				...
				<TR vAlign="top">
					<TD style="HEIGHT: 226px; width: 616px;" vAlign="top">
						<TABLE cellSpacing="1" cellPadding="0" width="100%" bgColor="#c7bebc" border="0">
							<TR>
								<TD style="HEIGHT: 14px; width: 948px;" background="images/TrainAD.gif" bgColor="#e6e6e6">&nbsp;&nbsp;<IMG height="12" alt="" src="images/ico_arrow.gif" width="16" border="0"><FONT style="COLOR: #ff6666">&nbsp;资产会计类别信息</FONT></TD>
							</TR>
