				...
				<TR vAlign="top">
					<TD style="HEIGHT: 226px; width: 616px;" vAlign="top">
						<TABLE cellSpacing="1" cellPadding="0" width="100%" bgColor="#c7bebc" border="0">
							<TR>
								<TD style="HEIGHT: 14px; width: 948px;" background="images/TrainAD.gif" bgColor="#e6e6e6">&nbsp;&nbsp;<IMG height="12" alt="" src="images/ico_arrow.gif" width="16" border="0"><FONT style="COLOR: #ff6666">&nbsp;员工信息列表</FONT></TD>
							</TR>
							<TR id="taskDiv" vAlign="top">
								<td vAlign="top" bgColor="#ffffff" style="width: 948px; height: 467px;">
												<TABLE cellSpacing="10" cellPadding="0" width="757" border="0" style="WIDTH: 757px; HEIGHT: 325px">
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <asp:Label ID="labcode" runat="server" Text="雇员编号："></asp:Label>
                                                            <asp:TextBox ID="txtcode" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:Label ID="labname" runat="server" Text="员工名称："></asp:Label>
													...
													<TR vAlign="top">
														<TD style="WIDTH: 84px; height: 130px;" colSpan="4"><FONT face="宋体"><asp:datagrid id="MyDataGrid" runat="server" AutoGenerateColumns="False" BorderWidth="1px" Font-Names="Verdana"
																	...
																	<Columns>
																		<asp:BoundColumn DataField="CCTEMPLOYEECODE" HeaderText="雇员编号">
																			<HeaderStyle Width="150px"></HeaderStyle>
																		</asp:BoundColumn>
																		<asp:BoundColumn DataField="EMPLOYEENAME" HeaderText="员工姓名">
																			<HeaderStyle Width="400px"></HeaderStyle>
																		</asp:BoundColumn>
																		<asp:BoundColumn DataField="EMPLOYEECODE" HeaderText="JDE编号">
