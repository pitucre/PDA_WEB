<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentList.aspx.cs" Inherits="FixedAssetBarcodeScanProject.DepartmentList" %>
				...
				<TR vAlign="top">
					<TD style="HEIGHT: 226px; width: 616px;" vAlign="top">
						<TABLE cellSpacing="1" cellPadding="0" width="100%" bgColor="#c7bebc" border="0">
							<TR>
								<TD style="HEIGHT: 14px; width: 948px;" background="images/TrainAD.gif" bgColor="#e6e6e6">&nbsp;&nbsp;<IMG height="12" alt="" src="images/ico_arrow.gif" width="16" border="0"><FONT style="COLOR: #ff6666">&nbsp;部门信息列表</FONT></TD>
							</TR>
							<TR id="taskDiv" vAlign="top">
								<td vAlign="top" bgColor="#ffffff" style="width: 948px; height: 467px;">
												<TABLE cellSpacing="10" cellPadding="0" width="757" border="0" style="WIDTH: 757px; HEIGHT: 325px">
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <asp:Label ID="labDeptcode" runat="server" Text="部门编号："></asp:Label>
                                                            <asp:TextBox ID="txtDeptcode" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:Label ID="labDeptname" runat="server" Text="部门名称："></asp:Label>
