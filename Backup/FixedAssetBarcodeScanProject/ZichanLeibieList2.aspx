<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZichanLeibieList2.aspx.cs" Inherits="FixedAssetBarcodeScanProject.ZichanLeibieList2" %>
				...
				<TR vAlign="top">
					<TD style="HEIGHT: 226px; width: 616px;" vAlign="top">
						<TABLE cellSpacing="1" cellPadding="0" width="100%" bgColor="#c7bebc" border="0">
							<TR>
								<TD style="HEIGHT: 14px; width: 948px;" background="images/TrainAD.gif" bgColor="#e6e6e6">&nbsp;&nbsp;<IMG height="12" alt="" src="images/ico_arrow.gif" width="16" border="0"><FONT style="COLOR: #ff6666">&nbsp;资产设备类别信息</FONT></TD>
							</TR>
												...
												<TABLE cellSpacing="10" cellPadding="0" width="757" border="0" style="WIDTH: 757px; HEIGHT: 325px">
													...
													<TR vAlign="top">
														<TD style="WIDTH: 84px; height: 130px;" colSpan="4"><FONT face="宋体"><asp:datagrid id="MyDataGrid" runat="server" AutoGenerateColumns="False" BorderWidth="1px" Font-Names="Verdana"
																	...
																	<Columns>
																		<asp:BoundColumn DataField="LEIBIEBIANMA" HeaderText="资产编号">
																			<HeaderStyle Width="150px"></HeaderStyle>
																		</asp:BoundColumn>
																		<asp:BoundColumn DataField="LEIBIEMINGCHENG" HeaderText="资产名称">
